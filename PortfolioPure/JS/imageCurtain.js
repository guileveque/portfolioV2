//import {Curtains, Plane, Vec2} from '../curtains.umd.min.js';
...
window.addEventListener("load", () => {
    ...
    const planeElements = document.getElementsByClassName("curtain2");
    ...
    simplePlane.onReady(() => {
        ...
        const wrapper = document.getElementById("page-wrap2");
...
window.addEventListener("load", () => {
    ...
    // get our plane element
    const planeElements = document.getElementsByClassName("curtain3");
    ...
    simplePlane.onReady(() => {
        ...
        // now that our plane is ready we can listen to mouse move event
        const wrapper = document.getElementById("page-wrap3");
...
window.addEventListener("load", () => {
    ...
    // get our plane element
    const planeElements = document.getElementsByClassName("curtain4");
    ...
    simplePlane.onReady(() => {
        ...
        // now that our plane is ready we can listen to mouse move event
        const wrapper = document.getElementById("page-wrap4");
